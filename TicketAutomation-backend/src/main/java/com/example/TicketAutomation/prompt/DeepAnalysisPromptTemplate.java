...
@NoArgsConstructor
public class DeepAnalysisPromptTemplate {

    public static String build(String title , String description , String conversation){
        return """
                ...
                Conversation :\s
                %s
                """.formatted(title,description,conversation);
    }
}
